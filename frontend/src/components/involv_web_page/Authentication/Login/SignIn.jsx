    ...
    <div className="min-h-screen w-[100%] bg-white ">
      ...
      <div className="pt-8 flex justify-center">
        <div
          ...
          className="w-72  h-14 flex items-center justify-between pl-1 bg-gray-200 rounded-full  cursor-pointer relative shadow-md"
        >
          <span
            className={`text-lg relative z-10 font-semibold px-5 transition-colors duration-300 ${isUser ? "text-white" : "text-gray-700"
              }`}
          >
            User
          </span>
          ...
          {/* Sliding knob */}
          <div
            className={`absolute top-1 bottom-1 w-1/2 bg-[#000075] opacity-40 rounded-full transition-transform duration-300 ${isUser ? "translate-x-0" : "translate-x-full"
              }`}
          ></div>
          ...
          {/* Sliding toggle knob */}
          <div
            className={`absolute top-1 bottom-1 w-1/2 bg-[#000075] opacity-30  rounded-full transition-transform duration-300 ${isUser ? "translate-x-0" : "translate-x-full"
              }`}
          ></div>
        </div>
      </div>
      <div className="flex justify-center items-center pt-10 pb-16">
        ...
        <div
          className="h-[470px] w-[280px] md:h-[480px] md:w-[320px] lg:w-[407px] lg:h-[570px] bg-white shadow-[0px_5px_10px_-3px_rgba(0,_0,_0,_0.7)]
          rounded-[22.92px] "
        >
