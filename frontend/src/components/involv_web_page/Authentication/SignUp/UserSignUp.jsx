...
export default function Signup() {
  ...
  const handleChange = (e) => {
    ...
    // Dynamic phone check only (as you requested)
  ...
  const handleSubmit = () => {
    ...
    if (Object.keys(newErrors).length === 0) {
      console.log("All good, send OTP here");
      alert("Submitting… OTP process starts");
    }
  };

  return (
    <div className="min-h-screen bg-[#EDF2FF] p-6">
        ...
        <div className="p-10">
          ...
          <div className="space-y-5">
            ...
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 transition text-white py-3 rounded-lg font-semibold shadow cursor-pointer"
            >
              Create Account
            </button>
        ...
        <div className="bg-blue-600 text-white flex flex-col justify-center p-10">
          ...
          <ul className="space-y-4 text-lg">
            <li className="flex gap-3 items-start hover:translate-x-1 transition cursor-pointer">
              ...
              <span>
                Find the nearest store with your required product instantly.
              </span>
            </li>
            ...
            <li className="flex gap-3 items-start hover:translate-x-1 transition cursor-pointer">
              <span className="text-2xl">🛒</span>
              <span>
                Check real-time stock availability & best pricing from vendors.
              </span>
            </li>
            ...
            <li className="flex gap-3 items-start hover:translate-x-1 transition cursor-pointer">
              ...
              <span>
                Get optimized route navigation from your location to the store.
              </span>
            </li>
            ...
            <li className="flex gap-3 items-start hover:translate-x-1 transition cursor-pointer">
              <span className="text-2xl">📦</span>
              <span>
                Vendors update inventory & prices in real time.
              </span>
            </li>
          </ul>
